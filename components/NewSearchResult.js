...
class NewSearchResult extends Component {
    ...
    showSearchText(){
        ...
        short_text = short_text.replace(regEx, '<span style="color:#44c735">'+search_text+'</span>');
    ...
    showTitle(){
        ...
        let regEx = new RegExp(search_text, "ig");
        short_text = short_text.replace(regEx, '<span style="color:#44c735">'+search_text+'</span>');
        return <h4 className="top4 link-h4" dangerouslySetInnerHTML={{__html: short_text}} />
    }
    render() {
        return (
