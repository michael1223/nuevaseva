            ...
            <div className={"c-row-module1 " + this.props.aClass}>
                ...
                <div className="right-col-news">
                    ...
                    <div>
                        ...
                        <SocialIcons shareLink={"/blog/"+this.props.id+"-"+this.props.slug} social={this.props.social} shareImg={this.props.imageUrl?this.props.imageUrl:window.location.protocol + "//" + window.location.host +"/images/banner-logo.png"}  />
                    </div>
                </div>
            </div>
        )
