            ...
            <li className={item.reply?"":"bord-bott-no"} key={i++}>
                <div className={"comment-li"}>
                    <div className="comment-main-content">
                      ...
                      {/*  <div className="avatar2 avatar2-comment avatar-offset1">R</div>*/}
                        <div className="comment-list-text">
            ...
            return (
                <div className="c-comments">
                    ...
                    <div className="c-area">
                        {/*<i className="flaticon-social u-avatar" />*/}
                        ...
                        <textarea onChange={this.handleTextChange} value={this.props.viewerStore.CommentAreaText} className="cu-textarea" placeholder="Escribe tu comentario aquí ..." />
                    </div>
                    <a href="#" onClick={(e)=>{e.preventDefault(); this.props.viewerStore.addComment(this.props.type?this.props.type:"lesson");}} className="btn1 bp-btn"><i className="flaticon-edit" />{this.props.type!="lesson"?"conéctate o crea una cuenta":"Enviar Comentario"}</a>
