                ...
                <div className="c-popup-cover" onClick={()=>{this.hidePopup()}}>
                    <div className="c-popup" onClick={(e)=>{e.stopPropagation()}}>
                        ...
                        <div className="w-popup-content cnp-popup">
                            <h3 className="h3-popup">Crear una nueva contraseña</h3>
                            <p className="p-popup">Te preguntaremos esta contraseña cada vez que inicies nuevamente tu sesión.</p>
                            ...
                            <form action="" className="fotm1">
                                ...
                                <div className="form-item fi-desk">
                            ...
                            {this.showError()}
                            <Link onClick={(e)=>{e.preventDefault(); this.props.authStore.changePassword(this.state.password, this.state.confirmPassword); }} to="#" className="btn1">Guardar cambios</Link>
                        </div>
                    </div>
                </div>
            );
