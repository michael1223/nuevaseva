...
class RegisterPopup extends Component {
    constructor(props){
        ...
        if(props.themeStore.ThemesList.length==0){
            props.themeStore.pullThemesList();
        }
    };
    componentWillMount(){
        ...
        return(
            <form className="fotm1" style={{display:this.props.viewerStore.registerStep==2?" none":"block"}}>
                ...
                <div className="c-reg-popup-link">
                    <Golink click={(e)=>{this.props.viewerStore.showLogin()}} chref="" size="gl1">¿Ya tienes una cuenta? Conéctate aquí</Golink>
                </div>
...
/*https://developers.facebook.com/apps/1996370243971490/fb-login/settings/*/
    ...
    showTopTitle(){
        ...
        if(this.props.viewerStore.registerStep==1 && !this.props.viewerStore.AfterBuy){
            ...
            return (
                <div>
                    ...
                    <h3 className="p-reg-title-mob desk-hide">Crea tu cuenta,<br/>
                        ¡Es gratis!</h3>
                </div>
            )
        }
        ...
        if(this.props.viewerStore.registerStep==2 && !this.props.viewerStore.AfterBuy){
            return (
                <h3 className="p-reg-title">Marca según tu interés:</h3>
            )
        }
    }
