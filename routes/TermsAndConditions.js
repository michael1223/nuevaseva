            ...
            return (
                <div className="page">
                    ...
                    <div className="container terms ">
                        <div className="terms-btn-w top1"><Link to="#" onClick={(e)=>{e.preventDefault(); this.props.paymentStore.setCheckoutCheckbox(true); history.go(-1);}} className="btn1">Acepto, Regresar a mi ComprA</Link></div>
