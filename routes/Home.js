        ...
        if(!this.props.viewerStore.token) {
            return (
                <div className="c-cont2">
                    <h3 className="h3-2 text-center">
                        {this.props.themeStore.bubbleBanner.bubble_account_text}
                        {/*Esta semana, <span className="under-text2">500 mujeres</span> se han unido a Nuevas Evas <br/>
                         para Sanar. Hoy es tu Turno.*/}
                    </h3>
            ...
            return(
                <div ref="foro" className="c-foro-header">
                    <div className="c-f-foro-title">
                        ...
                        <Link to="/nueva-discusion" className="btn1 btn-foro"><i className="flaticon-edit" />CREAR DISCUSIÓN AQUÍ</Link>
                    </div>
                </div>
            );
        } else {
        ...
        if(!this.props.viewerStore.token){
            ...
            return (
                <div className="text-center c-green-button">
                    <Link to="/nueva-discusion" className="green-button gb2">
                    ...
                    <div className="container">
                        ...
                        <div className="text-center c1">
                            <Gobutton
                                ...
                                prevent={true}
                            >
                                REGÍSTRATE GRATIS EN NUESTRA COMUNIDAD
                            </Gobutton>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div className="text-center c1">
                            <Gobutton
                                ...
                                prevent={true}
                            >
                                REGÍSTRATE Y CONOCE MÁS HISTORIAS
                            </Gobutton>
                        </div>
                    </div>
                </div>
        ...
        if (this.props.themeStore.currentSubTheme == ""){ // Without Subtheme
            ...
            if(this.props.themeStore.currentTheme == "" || this.props.themeStore.currentTheme == "alimentacion-saludable"){
                ...
                if(this.props.viewerStore.currPage > 1){
                    ...
                    vDescription = "Página "+this.props.viewerStore.currPage+". "+this.props.themeStore.currentThemeMetaDesc;
                }
                else
                // without pagination
                {
            ...
            if(this.props.viewerStore.currPage > 1){
                ...
                vDescription = "Página "+this.props.viewerStore.currPage+", "+this.props.themeStore.currentSubThemeName+". Nuevas Evas es una comunidad donde aprendes cómo cuidar tu salud utilizando los alimentos como medicina natural, recibe el apoyo de especialistas de nutrición. Comparte consejos de salud con otras mujeres.";
            }
            else
            // without pagination
            {
                vTitle =  this.props.themeStore.currentSubThemeName+" y alimentación-saludable, tratamientos y medicina natural - Nuevas Evas";
                vDescription = this.props.themeStore.currentSubThemeName+" y alimentación-saludable. Nuevas Evas es una comunidad donde aprendes cómo cuidar tu salud utilizando los alimentos como medicina natural, recibe el apoyo de especialistas de nutrición. Comparte consejos de salud con otras mujeres.";
            }
        }
        return (
                <MetaTags>
                        ...
                        <div className="col-md-5">
                            <div className="c-offset1">
                                ...
                                <div className="c-module">
                                    <Title1 chref={"/blog/"+this.props.themeStore.currentTheme}>Artículos Recientes {this.props.themeStore.currentTheme==""?"":this.props.themeStore.currentThemeName}</Title1>
                                    {this.showArticles()}
                                ...
                                {/* unit 6 */}
                                <div className="c-module top4">
                                    <Title1 chref={this.props.themeStore.currentTheme==""?"":"/blog/"+this.props.themeStore.currentTheme+"/"+this.props.themeStore.recipeSlug}>Recetas Recientes {this.props.themeStore.currentTheme==""?"":this.props.themeStore.currentThemeName}</Title1>
                                    {this.showReceipts()}
