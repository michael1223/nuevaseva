    ...
    showFBcheckbox(){
        if(this.props.userStore.currentUser && this.props.userStore.currentUser.user_id){
            if(!this.props.userStore.currentUser.is_fb_checked){
                ...
                return(
                    <div>
                        You’ve been subscribed to NuevasEvas Messenger notifications. <br/> If you want to unsubscribe, please, follow
                        by the next <a className="link2" href="https://www.facebook.com/messages/t/nuevasclevercrew">link</a>
                    </div>
                );
            }
        }
            ...
            <div className="page">
                ...
                <div className="container c-ep top1">
                    ...
                    <form className="fotm1">
                        <div className="ep-b1">
                            <div className="ep-b1-1">Nombre real</div>
                        ...
                        <div className="ep-b1">
                            <div className="ep-b1-1">Apodo comunidad</div>
                        ...
                        <div className="ep-b1">
                            <div className="ep-b1-1">Rol comunidad</div>
                        ...
                        <div className="ep-b1">
                            ...
                            <div className={(this.props.userStore.validators.occupationMsg)?"ep-b1-2 error-field":"ep-b1-2"}>
                                ...
                                <input onChange={this.handleOccupationChange} type="text" className="cui2" value={this.props.userStore.newOccupation}/>
                            </div>
