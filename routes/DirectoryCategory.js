...
class DirectoryCategory extends Component {
    ...
    showMetaData(){
        ...
        if(this.props.directoriesStore.CategoryInfo) {
                    ...
                    <div className="row">
                        <div className="col-md-7">
                            ...
                            <div className="c-module top2 top1m">
                                <Title1 isGoLink={false}><img className="country-flag" src={this.props.directoriesStore.CountryInfo.flag_image}/> {this.props.directoriesStore.CategoryInfo.title}: {this.props.directoriesStore.CityInfo.name}</Title1>

                                {this.showBusinesses()}

                                <div className="top1"><Pagination type={"directory"}  /></div>

                                <div className={(this.props.viewerStore.token)?"directory-add":"hide-block"}>
