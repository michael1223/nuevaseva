...
class NuevasVisitor extends Component {
    ...
    showThemesList(){
        if(this.props.themeStore.ThemesList.length) {
            return this.props.themeStore.ThemesList.map(item =>
                <li key={item.id}><Link to={`/${item.slug}`} className="link1 col-lg-6 b6-col1">{item.name}</Link></li>
            );
        }
        else return null
    }
    ...
    showCuText(){
        ...
        let newURL = window.location.protocol + "//" + window.location.host + "/las-nuevas-evas";
        ...
        if(!this.props.viewerStore.token){
            ...
            return (
                <div>
                <h3 className="h3-5">¿Te gusta nuestra historia? ¡Compártela, más mujeres <span className="under-text">necesitan entrarse</span>!</h3>
        ...
        return (
            <div className="page">
                ...
                <div className="container top1">
                    ...
                    <div>
                        <h3 className="light-text">Esto lo sabía tu abuela e ¡Hipócrates!</h3>
                    </div>
                    ...
                    <div className="c-b2">
                        ...
                        <p className="p-small">Este rol ha quedado en otras manos y este conocimiento se ha perdido.</p>
                    </div>

                    <div className="c-b3">
                        <h3 className="light-text top3">¿El resultado?</h3>
                    </div>
                    ...
                    <div className="c-b5">
                        <h3 className="light-text ">Filosofía de curación</h3>
                    ...
                    <div className="c-b6">
                        <div className="w-b6">
                            <h3>¿Puedo comer otros alimentos?</h3>
                    ...
                    <div className="c-b7 top3 text-center">
                        ...
                        <h3 className="h3-7 top3">Aquí mismo. ¡Somos una Comunidad Online!</h3>
                        <div className="">
                    ...
                    <div className="c-b4">
                        <div className="w-b4">
                            ...
                            {this.showCuText()}
                            <div className="bott3">{this.showRegisterBtn()}</div>
                        </div>
                    </div>
                </div>
            </div>
