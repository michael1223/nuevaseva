...
class Checkout extends Component {
    ...
    handleOptionChange2 = (changeEvent) => {
        if(changeEvent.target.value!="PayPal"){
            ...
            this.setState({flag: ""});
            this.props.paymentStore.setCountry('Pais', '', '');
            ...
            <ul id="checkboxes" className="radio-but-list radio-list no-display-country" onClick={(e)=>{e.stopPropagation()}}>
                ...
                <li>
                    <input type="radio"
                           ...
                           onClick={this.handleOptionChange2}
                           value="PayPal"
                           title={"Otro Pais - Pagar con PayPal"}
                           data-code={""}
                           data-flag={""}
                           key={0}
                    />
                    <label htmlFor="other">Otro Pais - Pagar con PayPal</label>
                </li>
            </ul>
        )
    }
    ...
    showPayUsubmitBtn(){
        if (!this.props.paymentStore.inProgressPU){
            return (
                <Gobutton prevent={true} click={()=>this.props.paymentStore.payUpayment()} padd='52px'>Completar el pago</Gobutton>
            )
        } else {
            return (<div className="spinner" />)
        }
        ...
        if(this.props.paymentStore.payUid!=''){
            return (
                <div>
                    ...
                    <img src={"https://maf.pagosonline.net/ws/fp/clear.png?id="+this.props.paymentStore.payUid} />
            ...
            return(
                <form>
                    <div className={(this.props.paymentStore.validators.emailMsg)?"form-item error-field":"form-item"}>
                        ...
                        <input onChange={this.handleEmailChange} type="text" className="" placeholder="Correo Electrónico" />
                    </div>
                            ...
                            <div className="line-controls2">
                                ...
                                <div className={(this.props.paymentStore.validators.cityMsg)?"cu-sel cont-1-mob error-field":"cu-sel cont-1-mob"}>
                                    <select onChange={this.handleCityChange}>
                                        <option hidden="hidden" disabled="disabled" selected="selected"  key={0} value="0">Ciudad</option>
                                        {this.showCities()}
                                    </select>
                                </div>
                    ...
                    <div className={(this.props.paymentStore.validators.addressMsg)?"form-item error-field":"form-item"}>
                        <input onChange={this.handleAddressChange} type="text" className="" placeholder="Escribe tu Dirección" />
                    </div>
                    ...
                    <div className="form-item">
                        ...
                        <div className="line-controls2">
                            <div className={(this.props.paymentStore.validators.documentTypeMsg)?"cu-sel cont-1 error-field":"cu-sel cont-1"}>
                                <select onChange={this.handleDocTypeChange}>
                                    <option hidden="hidden" disabled="disabled" selected="selected" value="0">Seleccionar tipo de documento</option>

                                    <option key={0} value="CC">Cédula de Identidad</option>
                                    <option key={1} value="CC">Documento de Identidad</option>
                                    <option key={2} value="CE">Carnet de Extranjería</option>
                                </select>
                            </div>
                            <div className={(this.props.paymentStore.validators.documentNumberMsg)?"form-item cont-3 error-field":"form-item cont-3"}>
                                <input onChange={this.handleDocNumberChange} type="text"  placeholder="Tu número de Identidad" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={(this.props.paymentStore.validators.phoneMsg)?"form-item error-field":"form-item"}>
                        ...
                        <div className="country-code">
                            <img src={this.state.flag} /><span>{this.props.paymentStore.countryCode}</span>
                        </div>
                        <input onChange={this.handlePhoneChange} type="text" className="phone" placeholder="Escribe tu Número de Celular" />
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="checkout-info-text">
                                Si necesitas ayuda para completar tu pago, escríbenos por whatsapp al 0051973586834.
                            </div>
