...
class DirectoryPostOnline extends Component {
    ...
    showMetaData(){
        ...
        if(this.props.directoriesStore.Business) {
            vTitle = this.props.directoriesStore.Business.title+", "+this.props.directoriesStore.CategoryInfo.title+" - Nuevas Evas";
            vDescription = this.props.directoriesStore.Business.meta_description!=null?this.props.directoriesStore.Business:"Nuevas Evas";
        }
