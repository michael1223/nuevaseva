...
class BlogPost extends Component {
    constructor(props){
        super(props);
        let slug = "";
        let postURL = props.match.params.postSlug;
            ...
            return (
                <div className="c-order">
                    ...
                    <InfoPanelBlog
                        ...
                        shareImg={this.props.blogStore.currPost.image?this.props.blogStore.currPost.image:window.location.protocol + "//" + window.location.host +"/images/banner-logo.png"}
    ...
    render() {
        ...
        let shareUrl = window.location.protocol + "//" + window.location.host+"/blog/"+this.props.blogStore.currPost.id+"-"+this.props.blogStore.currPost.slug;
        ...
        return (
            <div className="page">
                {this.showMetaData()}
                <TopBanner type="small">Blog de Tratamientos & Remedios Naturales Para <span className="under-text">{this.props.themeStore.currentThemeName}</span></TopBanner>
                            ...
                            <div className="c-order">
                                ...
                                <div className="social-bar">
                                    ...
                                    <ul className="c-sb-items">
                                        ...
                                        <PinterestShareButton url={shareUrl} media={this.props.blogStore.currPost.image?this.props.blogStore.currPost.image:window.location.protocol + "//" + window.location.host + "/images/temp/blog-post.jpg"}>
                                            <li className="it-pr">
